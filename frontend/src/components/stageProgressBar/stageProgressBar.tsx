...
const StageProgressBar = ({ progress }: IStageProgressBarProps) => {
  return (
    <div className='h-[24px] relative bg-brown shadow-[inset_0_8px_var(--color-brown-light)] border-black border-b-[1.6px] rounded-[12px] rounded-b-[4px] overflow-hidden'>
      <div
